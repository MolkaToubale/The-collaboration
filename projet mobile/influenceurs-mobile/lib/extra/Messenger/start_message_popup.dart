...
class StartConversationPopUp extends StatefulWidget {
  const StartConversationPopUp({super.key});
                ...
                children: [
                  ...
                  ...suggestions.map((e) => Card(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            onTap: () async {
                              //Génération d'une conversation si inexistante et redirection si existante
                              context.read<ChatRoomProvider>().setCurrentRoomId(
                                  context
                                      ...
                                      .toUser(),
                                  e.toUser());
                              //Voir s'il y a des messages non lus ou pas
                              await context
