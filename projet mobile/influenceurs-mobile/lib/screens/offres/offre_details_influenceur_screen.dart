...
class OffreDetailsInfluenceur extends StatefulWidget {
  var offre;
  OffreDetailsInfluenceur(this.offre, {super.key});

  @override
  State<OffreDetailsInfluenceur> createState() => _OffreDetailsInfluenceurState();
}

class _OffreDetailsInfluenceurState extends State<OffreDetailsInfluenceur> {
  ...
  onTap: () async {
    if (isSpeaking) {
      ...
      await speak(
          'Libellé de l\'offre ${widget.offre.libelle} description ${widget.offre.description} dernier délai d\'envoi des candidatures  ${DateFormat('dd/MM/yyyy').format(widget.offre.dateFin)} Catégories  ${widget.offre.categories.toString()} publiée par  ${widget.offre.nomEntreprise} Cliquez sur le bouton à gauche pour modifier cette offre ou bien sur le bouton à droite pour la supprimer');
    }
                ...
                child:DelayedAnimation(
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () async {
                             Navigator.push(
       context,
       MaterialPageRoute(builder: (context) => AddCandidature(widget.offre)),
     );
                            },
                            child: const Text(
                              'Je Postule! ',
