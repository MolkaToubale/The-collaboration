...
class CategorieGastronomie extends StatefulWidget {
  const CategorieGastronomie({super.key});

  @override
 CategorieGastronomieState createState() =>CategorieGastronomieState();
}

class CategorieGastronomieState extends State<CategorieGastronomie> {
  List<OffreModel> offresGastronomie = [];

  Future<void> fetchOffresGastronomie() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Gastronomie", style: style.title.copyWith(fontSize: 20)),
          actions: [
  ...
  onTap: () async {
      ...
      // Sinon, reprendre la lecture
          await speak('Cette interface vous permet de visualiser toutes les offers appartenant à la catégorie Gastronomie pour lesquelles vous pouvez postuler à savoir  ${offresGastronomie.length.toString()} offres. Vous pouvez également effectuer une recherche à partir de la barre de recherche ou bien retourner à l\'interface d\'Accueil grâce à la flêche située à gauche en hait de la page. ');
        ...
        child: Column(
          children: [
            ...
            Expanded(
              ...
              itemCount: offresGastronomie.length,
              ...
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  crossAxisSpacing: 10),
              itemBuilder: (_, index) {
                return OffreWidget(offre: offresGastronomie[index]);
              },
            )),
          ],
        ),
