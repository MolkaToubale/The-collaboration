...
class CandidatureDetailsInfluenceur extends StatefulWidget {
  
  var candidature;
  CandidatureDetailsInfluenceur(this.candidature, {super.key});

  @override
  State<CandidatureDetailsInfluenceur> createState() => _CandidatureDetailsInfluenceurState();
}

class _CandidatureDetailsInfluenceurState extends State<CandidatureDetailsInfluenceur> {
